...
class fag2 : Fragment() {
    ...
    override fun onCreateView(
      ...
      cpu1sh.adapter   = cuadapter
        ...
        item.add(cpu3)
        item.add(cpu4)
        val g = gpu_re(R.drawable.n3050,"Nvidia RTX 3050")
        val g2 = gpu_re(R.drawable.n1650,"Nvidia GTX 1650")
        val g1 = gpu_re(R.drawable.n3060,"Nvidia RTX 3060")
        val g4 = gpu_re(R.drawable.n3080,"Nvidia RTX 3080")
